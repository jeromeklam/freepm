...
ADD COLUMN `from_prjv_id` BIGINT(20) UNSIGNED NULL COMMENT 'Identifiant de la version du projet' AFTER `prj_id`,
ADD COLUMN `to_prjv_id` BIGINT(20) UNSIGNED NULL COMMENT 'Identifiant de la version du projet' AFTER `from_prjv_id`, 
ADD COLUMN `user_id` BIGINT(20) NULL COMMENT 'Identifiant de l\'utilisateur qui a initié la demande' AFTER `to_prjv_id`,
ADD COLUMN `user_jvs_id` BIGINT(20) NULL COMMENT 'Identifiant de la personne qui va traiter la demande' AFTER `user_id`,
CHANGE `sta_id` `sta_id` BIGINT(20) UNSIGNED NOT NULL COMMENT 'Identifiant de l\'état' AFTER `user_jvs_id`, 
...
ADD KEY `fk_feature_user_jvs` (`user_jvs_id`), 
ADD KEY `fk_feature_parent` (`feat_parent_id`), 
ADD CONSTRAINT `fk_feature_project_version_from` FOREIGN KEY (`from_prjv_id`) REFERENCES `pm_project_version`(`prjv_id`),
ADD CONSTRAINT `fk_feature_project_version_to` FOREIGN KEY (`to_prjv_id`) REFERENCES `pm_project_version`(`prjv_id`);
...
CREATE TABLE `pm_issue` (
  ...
  `user_jvs_id` bigint(20) unsigned DEFAULT NULL COMMENT 'Identifiant de l''interlocuteur JVS',
  `current_user_id` bigint(20) unsigned DEFAULT NULL COMMENT 'Identifiant de l''interlocuteur Client courant',
  `current_user_jvs_id` bigint(20) unsigned DEFAULT NULL COMMENT 'Identifiant de l''interlocuteur JVS courant',
  `close_user_id` bigint(20) unsigned DEFAULT NULL COMMENT 'Identifiant de l''interlocuteur Client qui a fermé l''incident',
  `close_user_jvs_id` bigint(20) unsigned DEFAULT NULL COMMENT 'Identifiant de l''interlocuteur JVS qui a fermé l''incident',
  ...
  KEY `fk_issue_user_jvs` (`user_jvs_id`),
  KEY `fk_issue_current_user` (`current_user_id`),
  KEY `fk_issue_current_user_jvs` (`current_user_jvs_id`),
  KEY `fk_issue_close_user` (`close_user_id`),
  KEY `fk_issue_close_user_jvs` (`close_user_jvs_id`),
...
CREATE TABLE `pm_issue_histo` (
  ...
  `user_jvs_id` bigint(20) unsigned NOT NULL COMMENT 'Identifiant de l''interlocuteur JVS',
  `next_user_jvs_id` bigint(20) unsigned DEFAULT NULL COMMENT 'Identifiant de l''interlocuteur JVS à qui va être transféré l''incident',
  ...
  KEY `fk_issue_histo_user_jvs` (`user_jvs_id`),
  KEY `fk_issue_histo_next_user_jvs` (`next_user_jvs_id`),
