...
$routes_issue_category = [
    'free_p_m.issue_category.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/IssueCategory',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreePM::Model::IssueCategory',
        FFCSTRT::ROUTE_URL        => '/v1/prj_mgnt/issue_category/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreePM::Controller::IssueCategory',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreePM::Model::IssueCategory',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_p_m.issue_category.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/IssueCategory',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreePM::Model::IssueCategory',
        FFCSTRT::ROUTE_URL        => '/v1/prj_mgnt/issue_category',
        FFCSTRT::ROUTE_CONTROLLER => 'FreePM::Controller::IssueCategory',
    ...
    'free_p_m.issue_category.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/IssueCategory',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreePM::Model::IssueCategory',
        FFCSTRT::ROUTE_URL        => '/v1/prj_mgnt/issue_category/:issc_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreePM::Controller::IssueCategory',
    ...
    'free_p_m.issue_category.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/IssueCategory',
    ...
    'free_p_m.issue_category.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/IssueCategory',
    ...
    'free_p_m.issue_category.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/IssueCategory',
