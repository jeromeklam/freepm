...
/**
 * Routes for ProjectCategoryIssue
 *
 * @author jeromeklam
 */
$routes_project_category_issue = [
    'free_p_m.project_category_issue.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/ProjectCategoryIssue',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreePM::Model::ProjectCategoryIssue',
        FFCSTRT::ROUTE_URL        => '/v1/prj_mgnt/project_category_issue/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreePM::Controller::ProjectCategoryIssue',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreePM::Model::ProjectCategoryIssue',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_p_m.project_category_issue.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/ProjectCategoryIssue',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreePM::Model::ProjectCategoryIssue',
        FFCSTRT::ROUTE_URL        => '/v1/prj_mgnt/project_category_issue',
        FFCSTRT::ROUTE_CONTROLLER => 'FreePM::Controller::ProjectCategoryIssue',
    ...
    'free_p_m.project_category_issue.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/ProjectCategoryIssue',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreePM::Model::ProjectCategoryIssue',
        FFCSTRT::ROUTE_URL        => '/v1/prj_mgnt/project_category_issue/:prjci_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreePM::Controller::ProjectCategoryIssue',
    ...
    'free_p_m.project_category_issue.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/ProjectCategoryIssue',
    ...
    'free_p_m.project_category_issue.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/ProjectCategoryIssue',
    ...
    'free_p_m.project_category_issue.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/ProjectCategoryIssue',
