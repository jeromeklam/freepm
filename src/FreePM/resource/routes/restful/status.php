 ...
 */
$routes_status = [
    'free_p_m.status.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/Status',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreePM::Model::Status',
        FFCSTRT::ROUTE_URL        => '/v1/prj_mgnt/status/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreePM::Controller::Status',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreePM::Model::Status',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_p_m.status.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/Status',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreePM::Model::Status',
        FFCSTRT::ROUTE_URL        => '/v1/prj_mgnt/status',
        FFCSTRT::ROUTE_CONTROLLER => 'FreePM::Controller::Status',
    ...
    'free_p_m.status.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/Status',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreePM::Model::Status',
        FFCSTRT::ROUTE_URL        => '/v1/prj_mgnt/status/:sta_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreePM::Controller::Status',
