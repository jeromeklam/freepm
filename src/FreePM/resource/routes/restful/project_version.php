...
/**
 * Routes for ProjectVersion
 *
 * @author ericmendez
 */
$routes_project_version = [
    'free_p_m.project_version.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/ProjectVersion',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreePM::Model::ProjectVersion',
        FFCSTRT::ROUTE_URL        => '/v1/prj_mgnt/project_version/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreePM::Controller::ProjectVersion',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreePM::Model::ProjectVersion',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_p_m.project_version.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/ProjectVersion',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreePM::Model::ProjectVersion',
        FFCSTRT::ROUTE_URL        => '/v1/prj_mgnt/project_version',
        FFCSTRT::ROUTE_CONTROLLER => 'FreePM::Controller::ProjectVersion',
        ...
        FFCSTRT::ROUTE_MIDDLEWARE => [],
        FFCSTRT::ROUTE_INCLUDE    => [
            FFCSTRT::ROUTE_INCLUDE_DEFAULT => ['project']
        ],
        FFCSTRT::ROUTE_SCOPE      => [],
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
    ...
    'free_p_m.project_version.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/ProjectVersion',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreePM::Model::ProjectVersion',
        FFCSTRT::ROUTE_URL        => '/v1/prj_mgnt/project_version/:prjv_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreePM::Controller::ProjectVersion',
    ...
    'free_p_m.project_version.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/ProjectVersion',
    ...
    'free_p_m.project_version.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/ProjectVersion',
    ...
    'free_p_m.project_version.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreePM/PrjMgnt/ProjectVersion',
